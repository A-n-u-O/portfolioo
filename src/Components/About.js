...
const About = ({ resume }) => {
  return (
    <section
      id="about"
      className="about py-12 px-8 md:px-16 bg-gray-100 flex flex-col md:flex-row items-center text-left">
      {/* Image Section */}
      <div className=" w-3/4 md:w-1/2 flex justify-center md:justify-start mb-6 md:mb-0">
        <img
